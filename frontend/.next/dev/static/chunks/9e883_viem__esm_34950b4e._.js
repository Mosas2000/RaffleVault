...
function hexToNumber(hex, opts = {}) {
    ...
    if (!Number.isSafeInteger(number)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$encoding$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IntegerOutOfRangeError"]({
...
async function fillTransaction(client, parameters) {
    ...
    try {
        ...
        const format = chain?.formatters?.transaction?.format || __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$formatters$2f$transaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatTransaction"];
...
function decodeEventLog(parameters) {
    ...
    for(let i = 0; i < indexedInputs.length; i++){
        ...
        if (!topic) {
            if (strict) throw new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$abi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecodeLogTopicsMismatch"]({
                abiItem,
                param: param
            });
    ...
    if (inputsToDecode.length > 0) {
        if (data && data !== '0x') {
            try {
                const decodedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$decodeAbiParameters$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeAbiParameters"])(inputsToDecode, data);
                if (decodedData) {
                    let dataIndex = 0;
...
function parseEventLogs(parameters) {
    ...
    return logs.map((log)=>{
        ...
        const abiItems = abi.filter((abiItem)=>abiItem.type === 'event' && log.topics[0] === (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$hash$2f$toEventSelector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toEventSelector"])(abiItem));
        ...
        for (const item of abiItems){
            try {
                event = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$decodeEventLog$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeEventLog"])({
                    ...log,
                    abi: [
                        item
                    ],
...
//# sourceMappingURL=9e883_viem__esm_34950b4e._.js.map